...
public class ObjectCreator {
	...
	public Object create(String type, String value) throws ClassNotFoundException, NoSuchMethodException, InvalidArgumentException {
		...
		if (c.isAssignableFrom(String.class)) {
			...
			if( !value.equalsIgnoreCase("true") && !value.equalsIgnoreCase("false") )
				throw new InvalidArgumentException(new String[]{"Wrong input value"});
