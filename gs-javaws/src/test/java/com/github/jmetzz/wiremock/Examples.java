...
import com.github.jmetzz.wiremock.testsupport.WireMockResponse;
...
public class Examples extends AcceptanceTestBase {
    ...
    public void toDoListScenario() {
        ...
        assertThat(response.content()).contains("Buy milk");
        assertThat(response.content()).doesNotContain("Cancel newspaper subscription");
