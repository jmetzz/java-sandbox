...
import com.github.jmetzz.concurrency.deployable.poolAcknoledge.handler.HandlerImpl;
import com.github.jmetzz.concurrency.deployable.poolAcknoledge.handler.IHandler;
import com.github.jmetzz.concurrency.deployable.poolAcknoledge.scheduler.Scheduler;
...
public class AppLauncher {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            URL jsonUrl = new File("java-multi-threading/src/main/resources/subscribers.json").toURI().toURL();
